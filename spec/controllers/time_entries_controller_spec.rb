...
RSpec.describe TimeEntriesController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all time_entries as @time_entries" do
      ...
      expect(assigns(:time_entries)).to eq([time_entry])
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved time_entry as @time_entry" do
        post :create, {:time_entry => invalid_attributes}, valid_session
        expect(assigns(:time_entry)).to be_a_new(TimeEntry)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested time_entry" do
        time_entry = TimeEntry.create! valid_attributes
        put :update, {:id => time_entry.to_param, :time_entry => new_attributes}, valid_session
        time_entry.reload
    ...
    describe "with invalid params" do
      it "assigns the time_entry as @time_entry" do
        time_entry = TimeEntry.create! valid_attributes
        put :update, {:id => time_entry.to_param, :time_entry => invalid_attributes}, valid_session
        expect(assigns(:time_entry)).to eq(time_entry)
      end
